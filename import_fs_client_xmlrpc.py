...
old_eu_fs_client_ids = models.execute_kw(db_name, uid, db_pwd, "eu.fs.client", "search_read",
    [[['old_eu_fs_client_id', '!=', False]]],{'fields': ['old_eu_fs_client_id'],'order': 'id'})


old_eu_fs_client_ids = list(map(lambda old: old['old_eu_fs_client_id'], old_eu_fs_client_ids))
