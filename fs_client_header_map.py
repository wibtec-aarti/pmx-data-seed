...
print(f'Total count of the rows in original input CSV file: {row_count}')  # 1,74,184 rows
print(f'Total count of the columns in original input CSV file: {col_count}')  # 328 Columns
print(f'Count of empty columns in original input CSV file: {len(empty_columns_set)}')  # 95
...
# print('\n************ Non empty Input CSV file ************\n')

print(f'Total count of the rows in non empty input CSV file: {new_row_count}')  # 1,74,184 rows
print(f'Total count of the columns in new input CSV file: {new_col_count}')  # 233 Columns
...
columns_to_keep = [
    ...
    'x_studio_entity_formation_doc_1_filename',
    'x_studio_entity_formation_doc_2_filename',
    'x_studio_operating_agreement_1_filename',
    'x_studio_operating_agreement_2_filename',
    'x_annual_income',
    'x_employer',
    'x_other_industry',
    ...
    'x_trulioo_errors',
    'x_kyc_drive',
    'x_trulioo_kyb_ownership_tree_link',
    'x_boCheckProcessId'
]
...
new_header = [
    ...
    'registered_address',
    'head_office_address',
    'entity_formation_doc_1_filename',
    'entity_formation_doc_2_filename',
    'operating_agreement_1_filename',
    'operating_agreement_2_filename',
    'annual_income',
    'ecop_employer',
    'other_industry',
    ...
    'trulioo_errors',
    'kyc_drive',
    'trulioo_kyb_ownership_tree_link',
    'bo_check_process_id'
]

print(f'\n\n Count of the new_header : {len(new_header)}')

new_df.columns = new_header

new_df.to_csv(update_file_path, index=False, encoding='latin1')
