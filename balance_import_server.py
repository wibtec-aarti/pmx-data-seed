...
LOG_FILE = "/opt/odoo/ftx_data/balances/balances_log_file.csv"
...
# Define directory 
DIR_PATH = "/opt/odoo/ftx_data/balances/file_chunks"
            ...
            for index in range(0, len(reader), batch_size):
                ...
                for row in batch:
                    try:
                        ...
                        logging.info(f"Processing file {file_name} : Row Number {num} : balances Record ID {current_row_id}")
